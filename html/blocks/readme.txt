RavenNuke Blocks System
======================


RavenNuke allows you to add new blocks by simply copying the block
files into its directory /blocks/.

Please read this doc carefully and remember that this system, as the whole
RavenNuke comes without any warranty and all you do from here is under
...
When installing a new block please be sure that the blank spaces on the filename
...
c) You have limited width space to show the block content. This limit is set by
   ...
   image your site will not display correctly.
...
NOTE: It is important to keep your code XHTML 1.0 Transitional compliant.
	You need to be sure you substitute all "&" characters in the URLs with "&amp;"
	tag and use a closing "/" on all tags that require them.  So, for example, the URL:
...
You should also strive to avoid using deprecated tags such as FONT, <center>, <b>, <u>, <i> etc.
You should be using <span>, <div>, and/or CSS to accomplis this.
