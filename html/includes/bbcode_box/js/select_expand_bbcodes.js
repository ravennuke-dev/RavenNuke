...
{
	this.id = id;
	this.size = this.min = 58;	// --- Adjust MINIMUM_BLOCK_HEIGHT here :-)
...
{
	return '&nbsp;&lsaquo;&nbsp;<a class="genmed" style="text-decoration:none;" href="javascript:void(0)" onclick="SXBB[\''+this.id+'\'].'+cmd+'(\''+txt+'\');" onfocus="this.blur();"><b>'+txt+'</b></a>&nbsp;&rsaquo;';
}
...
_SXBB.prototype.writeDiv = function()
{
	...
	//
	var s = ( SXBB_IsOverflowAble() ? 'style="overflow:hidden;height:'+this.min+'px;"' : '' );
