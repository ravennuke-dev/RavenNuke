...
if (!defined('_ADDCATEGORY')) define('_ADDCATEGORY','Ajouter une nouvelle cat&eacute;gorie');
...
if (!defined('_EDITCATEGORY')) define('_EDITCATEGORY','Editer la cat&eacute;gorie');
