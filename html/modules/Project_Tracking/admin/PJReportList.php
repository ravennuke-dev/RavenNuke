...
echo '<tr><td colspan="3" bgcolor="' . $bgcolor2 . '" nowrap="nowrap"><span class="thick">' . _PJ_REPORTOPTIONS . '</span></td></tr>'."\n";

$reportrows = $db->sql_numrows($db->sql_query('SELECT report_id FROM ' . $prefix . '_nsnpj_reports'));

$pjimage = pjimage('stats.png', $module_name);
echo '<tr><td><img src="' . $pjimage . '" alt="" title="" /></td><td colspan="2" width="100%" nowrap="nowrap">' . _PJ_TOTALREPORTS . ': <span class="thick">' . $reportrows . '</span></td></tr>'."\n";
echo '</table>'."\n";
echo '<br />'."\n";
...
echo '<table width="100%" border="1" cellspacing="0" cellpadding="2">'."\n";
echo '<tr><td bgcolor="' . $bgcolor2 . '" width="100%" colspan="2" nowrap="nowrap"><span class="thick">' . _PJ_REPORTLIST . '</span></td>'."\n";
