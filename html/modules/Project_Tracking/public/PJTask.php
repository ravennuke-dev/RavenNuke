...
echo '<tr><td bgcolor="' , $bgcolor2 , '" width="100%" colspan="5" nowrap="nowrap"><span class="thick">' , _PJ_PROJECTNAME , '</span></td></tr>',"\n";
...
echo '<tr><td bgcolor="' , $bgcolor2 , '" width="100%" colspan="2" nowrap="nowrap"><span class="thick">' , _PJ_TASKNAME , ' / ' , _PJ_TASKDETAILS , '</span></td>',"\n";
echo '<td bgcolor="' , $bgcolor2 , '" align="center" nowrap="nowrap"><span class="thick">' , _PJ_STATUS , '</span></td>',"\n";
echo '<td bgcolor="' , $bgcolor2 , '" align="center" nowrap="nowrap"><span class="thick">' , _PJ_PRIORITY , '</span></td>',"\n";
echo '<td bgcolor="' , $bgcolor2 , '" align="center" nowrap="nowrap"><span class="thick">' , _PJ_PROGRESSBAR , '</span></td></tr>',"\n";
...
if($task['date_started'] > 0) {
	...
	echo '<tr><td align="center"><img src="' , $pjimage , '" alt="" title="" /></td>',"\n";
	echo '<td width="100%" colspan="4" nowrap="nowrap">' , _PJ_STARTDATE , ': <span class="thick">' , $start_date , '</span></td></tr>',"\n";
}
...
if($task['date_finished'] > 0) {
	...
	echo '<tr><td align="center"><img src="' , $pjimage , '" alt="" title="" /></td>',"\n";
	echo '<td width="100%" colspan="4" nowrap="nowrap">' , _PJ_FINISHDATE , ': <span class="thick">' , $finish_date , '</span></td></tr>',"\n";
}

echo '<tr><td bgcolor="' , $bgcolor2 , '" colspan="3" nowrap="nowrap"><span class="thick">' , _PJ_TASKMEMBERS , '</span></td>',"\n";
echo '<td bgcolor="' , $bgcolor2 , '" align="center" colspan="2" nowrap="nowrap"><span class="thick">' , _PJ_POSITION , '</span></td></tr>',"\n";
...
if(is_admin($admin)) {
	echo '<tr><td bgcolor="' , $bgcolor2 , '" colspan="5" width="100%" nowrap="nowrap"><span class="thick">' , _PJ_ADMINFUNCTIONS , '</span></td></tr>',"\n";
