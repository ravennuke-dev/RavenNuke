...
$license = 'GNU/GPL';
$download_location = 'http://trickedoutnews.com/downloads-cat5.html';
$module_version = '2.6';
$module_description = 'This is a mod of the original news module to act and look more like a blog';
...
function show_copyright() {
	...
	echo '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"'
		...
		. $module_name . ' for <a href="http://ravenphpscripts.com" target="_blank">RavenNuke(tm) 2.40.xx</a><br /><br />'
		. '</span>'
		. '</div>'
