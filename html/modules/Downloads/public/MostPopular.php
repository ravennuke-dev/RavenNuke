...
if ($ratenum != '' && $ratetype != '') {
	...
	if ($ratetype == 'percent') $dl_config['mostpopulartrig'] = 1; else $dl_config['mostpopulartrig'] = 0;
}
if ($dl_config['mostpopulartrig'] == 1) {
	...
	echo '<p align="center" class="option">' . _DL_MOSTPOPULAR . ' ' . $strRateNum . '% (' . _DL_OFALL . ' '
		. $totalmostpopdownloads . ' ' . _DL_DOWNLOADS . ')</p>';
} else {
	echo '<p align="center" class="option">' . _DL_MOSTPOPULAR . ' ' . $dl_config['mostpopular'] . '</p>';
}
echo '<table border="0" width="100%">';
echo '<tr><td align="center">' . _DL_SHOWTOP . ': [ <a href="modules.php?name=' . $module_name
