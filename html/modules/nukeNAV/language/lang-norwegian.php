...
// nukeNAV - menu
if (!defined('_NAV_NEWS')) define('_NAV_NEWS','Nyheter');
if (!defined('_NAV_AUTHART')) define('_NAV_AUTHART','Forfattere/Artikkler');
if (!defined('_NAV_STORARCH')) define('_NAV_STORARCH','Artikkelarkiv');
if (!defined('_NAV_TOPICS')) define('_NAV_TOPICS','Temaer');
if (!defined('_NAV_SUBMITNEWS')) define('_NAV_SUBMITNEWS','Send inn Artikkel');
if (!defined('_NAV_FORUMS')) define('_NAV_FORUMS','Forumer');
if (!defined('_NAV_NEWPOSTS')) define('_NAV_NEWPOSTS','Nye Foruminnlegg');
if (!defined('_NAV_UNANSWERED')) define('_NAV_UNANSWERED','Ubesvarte Innlegg');
if (!defined('_NAV_YOURPOSTS')) define('_NAV_YOURPOSTS','Dine Foruminnlegg');
if (!defined('_NAV_ADMINMODS')) define('_NAV_ADMINMODS','Admin Moduler');
if (!defined('_NAV_YOURACCOUNT')) define('_NAV_YOURACCOUNT','Din Brukerkonto');
if (!defined('_NAV_PM')) define('_NAV_PM','Private Meldinger');
if (!defined('_NAV_PREFS')) define('_NAV_PREFS','Preferanser');
if (!defined('_NAV_CHGTHEME')) define('_NAV_CHGTHEME','Bytte Utseende');
if (!defined('_NAV_SITEINFO')) define('_NAV_SITEINFO','Informasjon');
if (!defined('_NAV_SITEMAP')) define('_NAV_SITEMAP','Sideoversikt');
if (!defined('_NAV_CONTACTS')) define('_NAV_CONTACTS','Kontakter');
if (!defined('_NAV_FEEDBACK')) define('_NAV_FEEDBACK','Tilbakemelding');
if (!defined('_NAV_RECOMMEND')) define('_NAV_RECOMMEND','Anbefal Oss');
if (!defined('_NAV_HOWTOINSTALL')) define('_NAV_HOWTOINSTALL','How to Install');
if (!defined('_NAV_LEGAL')) define('_NAV_LEGAL','Legal');
if (!defined('_NAV_MEMBERS')) define('_NAV_MEMBERS','Medlemmer');
if (!defined('_NAV_STATS')) define('_NAV_STATS','Statistikker');
if (!defined('_NAV_CREDITS')) define('_NAV_CREDITS','Kreditter');
if (!defined('_NAV_ADMIN')) define('_NAV_ADMIN','Admin');
if (!defined('_NAV_ACP')) define('_NAV_ACP','ACP');
if (!defined('_NAV_APPEARANCE')) define('_NAV_APPEARANCE','Utseende');
if (!defined('_NAV_BLOCKS')) define('_NAV_BLOCKS','Blokker');
if (!defined('_NAV_MSGS')) define('_NAV_MSGS','Meldinger');
if (!defined('_NAV_MODS')) define('_NAV_MODS','Moduler');
if (!defined('_NAV_LGL')) define('_NAV_LGL','Legal');
if (!defined('_NAV_SETTINGS')) define('_NAV_SETTINGS','Side Innstillinger');
if (!defined('_NAV_ADMINS')) define('_NAV_ADMINS','Administratorer');
if (!defined('_NAV_GROUPS')) define('_NAV_GROUPS','Grupper');
if (!defined('_NAV_POINTS')) define('_NAV_POINTS','Poeng');
if (!defined('_NAV_SECURITY')) define('_NAV_SECURITY','Sikkerhet');
if (!defined('_NAV_UTILS')) define('_NAV_UTILS','Verkt&oslash;y');
if (!defined('_NAV_BACKUP')) define('_NAV_BACKUP','Backup');
if (!defined('_NAV_OPTIMIZE')) define('_NAV_OPTIMIZE','Optimaliser');
if (!defined('_NAV_MAILER')) define('_NAV_MAILER','Mailer');
if (!defined('_NAV_NEWSTORY')) define('_NAV_NEWSTORY','Ny Nyhet');
if (!defined('_NAV_CHGPOLL')) define('_NAV_CHGPOLL','Endre Avstemming');
if (!defined('_NAV_COMMENTS')) define('_NAV_COMMENTS','Kommentarer');
if (!defined('_NAV_NEWS')) define('_NAV_NEWS','Nyheter');
...
if (!defined('_DESCRIPTION')) define('_DESCRIPTION','Beskrivelse');
...
if (!defined('_KEYWORDS')) define('_KEYWORDS','N&oslash;kkelord');
...
if (!defined('_NAV_VARIABLES')) define('_NAV_VARIABLES','% Variabler');
...
if (!defined('_LEVEL0')) define('_LEVEL0','Side');
if (!defined('_LEVEL1')) define('_LEVEL1','Modul');
if (!defined('_LEVEL2')) define('_LEVEL2','Kategori');
if (!defined('_LEVEL3')) define('_LEVEL3','Underkategori');
if (!defined('_LEVEL4')) define('_LEVEL4','Innhold');
