...
define('_MSNL_ADM_HLP_TOPIC', 'Dieser Text ersetzt die Betreffzeile {EMAILTOPIC}, in der '
	...
	. '40 Zeichen oder weniger sein, die genutzt werden.');
define('_MSNL_ADM_HLP_SENDER', 'Dieser Text ersetzt den Sender {SENDER} des Newsletters, '
	...
	. '20 Zeichen oder weniger sein, die genutzt werden.');
...
define('_MSNL_ADM_HLP_TEXTBODY', 'Dies ist der Haupttext des Newsletters. Es ist empfehlenswert, '
	...
	. 'Bei langen Texten k&ouml;nnen sie <span class="thick">&Uuml;bersichtspunkte</span> setzen, um direkt an eine bestimmte Stelle zu springen. '
	. ' Geben sie ihnen eindeutige Namen und setzen sie einen Haken bei der <span class="thick">&Uuml;bersichtspunkte einf&uuml;gen '
	. '</span>Option. Dadurch werden diese <span class="thick">&Uuml;bersichtspunkte</span> zu Links innerhalb der \'Tabellen&uuml;bersicht\' '
	. 'ihres Newsletters!<br /><br />Eins k&ouml;nnte zum Beispiel wie folgt lauten: '
	. '<span class="thick">& lt;a name=\'Bereich Eins\'& gt;& lt;/a& gt;</span>. <span class="thick">HINWEIS:</span> Es muss GENAUSO gemacht werden '
	. 'wie angegeben. Mit Anf&uuml;hrungszeichen UND abschließendem Link Tag! Dieses Beispiel erzeugt einen Link Namens '
	. '<span class="thick">Bereich Eins</span> innerhalb der \'Tabellen&uuml;bersicht\'. Beim anklicken eines Links wird der Leser direkt '
...
define('_MSNL_ADM_HLP_TEMPLATES', 'Diese Liste beinhaltet alle ihrer unter '
	...
	. ' sendet das System den reinen Text den sie oben im Feld <span class="thick">Newsletter Text</span> eingegeben haben.'
	. '<br /><br />Um einen Newsletter mit Hilfe einer Vorlage zu schicken, w&auml;hlen sie eine aus der Liste aus. '
	. 'F&uuml;r eine Vorschau ihres Newsletters, klicken sie auf das <span class="thick">Zeige</span> Icon, rechts '
	. 'neben dem Vorlagenamen.<br /><br />Sie k&ouml;nnen auch eigene Vorlagen erstellen und diese '
	. 'im Vorlagen-Ordner speichern.  <span class="thick">Hinweis:</span> Die Vorlage \'Fancy_Content\' ist die einzige '
...
define('_MSNL_ADM_HLP_INCLTOC', 'Das aktivieren dieser Funktion f&uuml;gt einen \'Tabellen&uuml;bersichts\' '
	...
	. 'erstellten <span class="thick">&Uuml;bersichtspunkten</span> innerhalb des <span class="thick">Newsletter Texts</span>.');
...
define('_MSNL_ADM_HLP_WHOSNDTOADM', 'Diese Option schick nur dem Administrator der Seite (Ihnen) '
	...
	. ' k&ouml;nnen sie ihn via dem <span class="thick">Sende getestete</span> Link'
...
define('_MSNL_ADM_HLP_WHOSNDTOADHOC', 'Diese Option schickt den Newsletter an '
	...
	. 'Komma (<span class="thick">,</span>) trennen, sollten es mehrere sein.');
//Sektion: NSN Groups
...
define('_MSNL_ADM_VAL_NOSENDTO', 'Keine Sende an Option gew&auml;hlt');
...
define('_MSNL_CFG_HLP_DEBUGMODE', 'Diese Option bietet dem Admin folgende'
	...
	. 'Informationen ihres Servers auslesen k&ouml;nnen. <span class="thick">HINWEIS: Diese Option verschickt keine e-Mails!</span>'
...
define('_MSNL_CAT_HLP_CATBLOCKLMT', 'Dieses Feld wird nur bei aktiv sein der <span class="thick">Zeige Kategorien</span> '
...
define('_MSNL_NLS_CHG_HLP_NSNGRPS', 'Als Vorraussetzung muss die obige <span class="thick">Berechtigungs</span> Option '
	...
	. 'Bei mehr als einer NSN Gruppe, m&uuml;ssen die Gruppen durch einen \'Gedankenstrich\' getrennt werden. Beispiel: <span class="thick">1-2-3</span>.');
