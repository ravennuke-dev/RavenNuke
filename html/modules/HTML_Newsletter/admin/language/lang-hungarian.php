...
define('_MSNL_COM_LAB_HELPLEGENDTXT', 'Hover your cursor over these icons for detailed help text');
...
define('_MSNL_ADM_HLP_TOPIC', 'This text replaces the {EMAILTOPIC} tag in the '
	...
	. 'best to keep it short and to the point - say 40 characters or less.');
define('_MSNL_ADM_HLP_SENDER', 'This text replaces the {SENDER} tag in the '
	. 'chosen template.  Since this tag is usually on a line with other tags, it would be '
	. 'best to keep it short and personal - say, less than 20 characters.');
...
define('_MSNL_ADM_HLP_TEXTBODY', 'This is where the main text of your newsletter '
	...
	. 'For long newsletter text, you may wish to use anchor tags to <span class="thick">mark</span> '
	. 'certain sections.  Give them descriptive names and then check the <span class="thick">Include Table of '
	. 'Contents</span> checkbox below and these anchors will become links within the Table of '
	. 'Contents within your newsletter! <br /><br />For example, one could use: '
	. '<span class="thick">& lt;a name=\'Section One\'& gt;& lt;/a& gt;</span>. <span class="thick">NOTE:</span> Must be EXACTLY as shown '
	. 'with double quotes AND the closing anchor tag! This example would produce a link called '
	. '<span class="thick">Section One</span> within the Table of Contents and upon clicking it, would take '
...
define('_MSNL_ADM_HLP_TEMPLATES', 'The list below is derived from the current '
	...
	. 'If you elect to go with <span class="thick">no template</span>, the system will simply send to your recipients '
	. 'an email with the text you entered above in the <span class="thick">Newsletter Text</span> text area.<br /><br />'
	. 'To create a newsletter from a template, select one from the list.  To see a sample of what '
	. 'your selected newsletter will look like, click on the <span class="thick">View</span> icon to the right of '
	. 'the template name text.<br /><br />You can also create your own templates and place them '
	. 'in the templates directory.  <span class="thick">Hint:</span> pattern off of Fancy_Content as this is the '
...
define('_MSNL_ADM_HLP_WHOSNDTOADM', 'Choosing this option will send a test newsletter '
	...
	. 'be sent to your intended recipients, use the <span class="thick">Send Tested</span> link towards the '
	. 'top of this page.');
...
define('_MSNL_ADM_VAL_NOSENDTO', 'No Send To option chosen');
...
define('_MSNL_CAT_HLP_CATBLOCKLMT', 'This field is used only if the <span class="thick">show categories</span> '
	. 'configuration option is checked and must be greater than zero.  Enter here the number of '
	. 'newsletters that should be shown under this category in the block. <span class="thick">If a value is not '
