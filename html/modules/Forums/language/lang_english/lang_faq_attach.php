...
$faq[] = array("How do I add an attachment?", "You can add attachments when you post a new post. You should see a <span class='italic'>Add an Attachment</span> form below the main posting box. When you click the <span class='italic'>Browse...</span> button the standard Open dialogue window for your computer will open. Browse to the file you want to attach, select it and click OK, Open or doubleclick according to your liking and/or the correct procedure for your computer. If you choose to add a comment in the <span class='italic'>File Comment</span> field this comment will be used as a link to the attached file. If you haven't added a comment the filename itself will be used to link to the attachment. If the board administrator has allowed it you will be able to upload multiple attachements by following the same procedure as described above until you reach the max allowed number of attachments for each post.<br/><br/>The board administrator sets an upper limit for filesize, defined file extensions and other things for attachments on the board. Be aware that it's your responsiblity that your attachments comply with the boards acceptance of use policy, and that they may be deleted without warning.<br/><br/>Please note that the boards owner, webmaster, administrator or moderators can not and will not take responsibility for any loss of data.");

$faq[] = array("How do I add an attachment after the initial posting?", "To add an attachment after the initial posting you'll need to edit your post and follow the description above. The new attachment will be added when you click <span class='italic'>Submit</span> to add the edited post.");

$faq[] = array("How do I delete an attachment?", "To delete attachments you'll need to edit your post and click on the <span class='italic'>Delete Attachment</span> next to the attachment you want to delete in the <span class='italic'>Posted Attachments</span> box. The attachment will be deleted when you click <span class='italic'>Submit</span> to add the edited post.");

$faq[] = array("How do I update a file comment?", "To update a file comment you'll need to edit your post, edit the text in the <span class='italic'>File Comment</span> field and click on the <span class='italic'>Update Comment</span> button next to the file comment you want to update in the <span class='italic'>Posted Attachments</span> box. The file comment will be updated when you click <span class='italic'>Submit</span> to add the edited post.");
