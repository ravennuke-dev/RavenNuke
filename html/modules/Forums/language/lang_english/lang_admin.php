...
$lang['Admin_intro'] = 'Thank you for choosing phpBB as your forum solution. This screen will give you a quick overview of all the various statistics of your board. You can get back to this page by clicking on the <span class="underline">Admin Index</span> link in the left pane. To return to the index of your board, click the phpBB logo also in the left pane. The other links on the left hand side of this screen will allow you to control every aspect of your forum experience. Each screen will have instructions on how to use the tools.';
...
$lang['Backup'] = 'Backup';
$lang['Restore_explain'] = 'This will perform a full restore of all phpBB tables from a saved file. If your server supports it, you may upload a gzip-compressed text file and it will automatically be decompressed. <span class="thick">WARNING</span>: This will overwrite any existing data. The restore may take a long time to process, so please do not move from this page until it is complete.';
...
$lang['Version_not_up_to_date'] = 'Your installation does <span class="thick">not</span> seem to be up to date. Updates are available for your version of phpBB, please visit <a href="http://www.nukeresources.com" target="_blank">http://www.nukeresources.com</a> to obtain the latest version of <span class="thick">BBToNuke</span> (the ported version of phpBB files for phpNuke).';
$lang['Latest_version_info'] = 'The latest available version is <span class="thick">phpBB %s</span>.';
$lang['Current_version_info'] = 'You are running <span class="thick">phpBB %s</span>.';
