...
$lang['Page_of'] = 'Page <span class="thick">%d</span> of <span class="thick">%d</span>'; // Replaces with: Page 1 of 2 for example
...
$lang['Online_users_zero_total'] = 'In total there are <span class="thick">0</span> users online :: ';
$lang['Online_users_total'] = 'In total there are <span class="thick">%d</span> users online :: ';
$lang['Online_user_total'] = 'In total there is <span class="thick">%d</span> user online :: ';
...
$lang['Record_online_users'] = 'Most users ever online was <span class="thick">%s</span> on %s'; // first %s = number of users, second %s is the date.
...
// Stats block text
//
$lang['Posted_articles_zero_total'] = 'Our users have posted a total of <span class="thick">0</span> articles'; // Number of posts
$lang['Posted_articles_total'] = 'Our users have posted a total of <span class="thick">%d</span> articles'; // Number of posts
$lang['Posted_article_total'] = 'Our users have posted a total of <span class="thick">%d</span> article'; // Number of posts
$lang['Registered_users_zero_total'] = 'We have <span class="thick">0</span> registered users'; // # registered users
$lang['Registered_users_total'] = 'We have <span class="thick">%d</span> registered users'; // # registered users
$lang['Registered_user_total'] = 'We have <span class="thick">%d</span> registered user'; // # registered users
$lang['Newest_user'] = 'The newest registered user is <span class="thick">%s%s%s</span>'; // a href, username, /a
...
$lang['Topic_Announcement'] = '<span class="thick">Announcement:</span>';
$lang['Topic_Sticky'] = '<span class="thick">Sticky:</span>';
$lang['Topic_Moved'] = '<span class="thick">Moved:</span>';
$lang['Topic_Poll'] = '<span class="thick">[ Poll ]</span>';

$lang['Mark_all_topics'] = 'Mark all topics read';
$lang['Topics_marked_read'] = 'The topics for this forum have now been marked read';

$lang['Rules_post_can'] = 'You <span class="thick">can</span> post new topics in this forum';
$lang['Rules_post_cannot'] = 'You <span class="thick">cannot</span> post new topics in this forum';
$lang['Rules_reply_can'] = 'You <span class="thick">can</span> reply to topics in this forum';
$lang['Rules_reply_cannot'] = 'You <span class="thick">cannot</span> reply to topics in this forum';
$lang['Rules_edit_can'] = 'You <span class="thick">can</span> edit your posts in this forum';
$lang['Rules_edit_cannot'] = 'You <span class="thick">cannot</span> edit your posts in this forum';
$lang['Rules_delete_can'] = 'You <span class="thick">can</span> delete your posts in this forum';
$lang['Rules_delete_cannot'] = 'You <span class="thick">cannot</span> delete your posts in this forum';
$lang['Rules_vote_can'] = 'You <span class="thick">can</span> vote in polls in this forum';
$lang['Rules_vote_cannot'] = 'You <span class="thick">cannot</span> vote in polls in this forum';
$lang['Rules_moderate'] = 'You <span class="thick">can</span> %smoderate this forum%s'; // %s replaced by a href links, do not remove!

$lang['No_topics_post_one'] = 'There are no posts in this forum.<br />Click on the <span class="thick">Post New Topic</span> link on this page to post one.';
...
$lang['HTML_is_ON'] = 'HTML is <span class="underline">ON</span>';
$lang['HTML_is_OFF'] = 'HTML is <span class="underline">OFF</span>';
$lang['BBCode_is_ON'] = '%sBBCode%s is <span class="underline">ON</span>'; // %s are replaced with URI pointing to FAQ
$lang['BBCode_is_OFF'] = '%sBBCode%s is <span class="underline">OFF</span>';
$lang['Smilies_are_ON'] = 'Smilies are <span class="underline">ON</span>';
$lang['Smilies_are_OFF'] = 'Smilies are <span class="underline">OFF</span>';
...
$lang['Agree_under_13'] = 'I Agree to these terms and am <span class="thick">under</span> 13 years of age';
$lang['Agree_over_13'] = 'I Agree to these terms and am <span class="thick">over</span> or <span class="thick">exactly</span> 13 years of age';
...
$lang['Search_keywords_explain'] = 'You can use <span class="underline">AND</span> to define words which must be in the results, <span class="underline">OR</span> to define words which may be in the result and <span class="underline">NOT</span> to define words which should not be in the result. Use * as a wildcard for partial matches';
...
$lang['Auth_Anonymous_Users'] = '<span class="thick">anonymous users</span>';
$lang['Auth_Registered_Users'] = '<span class="thick">registered users</span>';
$lang['Auth_Users_granted_access'] = '<span class="thick">users granted special access</span>';
$lang['Auth_Moderators'] = '<span class="thick">moderators</span>';
$lang['Auth_Administrators'] = '<span class="thick">administrators</span>';
