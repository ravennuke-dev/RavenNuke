...
$lang['Admin_intro'] = 'Grazie per aver scelto phpBB come Forum. Questa schermata mostra alcune Statistiche del tuo Forum. Puoi tornare a questa pagina cliccando sul link  <span class="underline">Admin Index</span> nel pannello di sinistra. Per tornare all\'indice del tuo forum, clicca il logo phpBB nel pannello di sinistra. Gli altri collegamenti nella parte sinistra dello schermo ti permettono di controllare ogni aspetto del tuo Forum, in tutte le schermata avrai le informazioni su come usare al meglio le varie funzioni. Per maggiori info e Supporto visita ( <a href="http://www.phpbb.com" target="_blank"><strong>phpBB.com</strong></a> o <a href="http://www.phpbb.it" target="_blank"><strong>phpBB.it</strong></a> )';
...
$lang['Backup'] = 'Backup';
$lang['Restore_explain'] = 'Questa funzione ripristinerà tutte le tabelle del forum phpBB da un file salvato. Se il tuo server lo supporta puoi caricare un file di testo con compressione Gzip e verrà automaticamente decompresso. <span class="thick">ATTENZIONE</span> Questa operazione sovrascriverà tutti i dati esistenti. L\'operazione di ripristino potrebbe impiegare molto tempo per essere completata. Non muoverti da questa pagina finché l\'operazione non sarà completata.';
...
$lang['Latest_version_info'] = 'L\'ultima versione disponibile è <span class="thick">phpBB %s</span>.';
$lang['Current_version_info'] = 'La tua Versione è <span class="thick">phpBB %s</span>.';
