...
$lang['Backup'] = 'Backup';
$lang['Restore_explain'] = 'Hiermit werden alle phpBB Tabellen aus einer Datei wiederhergestellt. Falls es dein Server unterstützt, kannst du auch einen GZip-komprimierten Text hochladen - er wird automatisch dekomprimiert! <span class="thick">ACHTUNG</span>: Es werden alle existierenden Daten überschrieben. Der Vorgang wird einige Zeit dauern, bitte verlasse diese Seite nicht, bis er abgeschlossen wurde.';
...
$lang['Version_not_up_to_date'] = 'Dein Forum ist wahrscheinlich <span class="thick">nicht</span> auf dem neuesten Stand. Es sind Updates für deine phpBB-Version verfügbar, bitte besuche <a href="http://www.nukeresources.com" target="_blank">http://www.nukeresources.com</a>, um die aktuellste Version zu erhalten.';
$lang['Latest_version_info'] = 'Die neueste verfügbare Version ist <span class="thick">phpBB %s</span>.';
$lang['Current_version_info'] = 'Du verwendest <span class="thick">phpBB %s</span>.';
