...
// Stats block text
//
$lang['Posted_articles_zero_total'] = 'Unsere Benutzer haben <span class="thick">noch keine</span> Beiträge geschrieben.'; // Number of posts
$lang['Posted_articles_total'] = 'Unsere Benutzer haben insgesamt <span class="thick">%d</span> Beiträge geschrieben.'; // Number of posts
$lang['Posted_article_total'] = 'Unsere Benutzer haben <span class="thick">einen</span> Beitrag geschrieben.'; // Number of posts
$lang['Registered_users_zero_total'] = 'Wir haben <span class="thick">keine</span> registrierten Benutzer.'; // # registered users
$lang['Registered_users_total'] = 'Wir haben <span class="thick">%d</span> registrierte Benutzer.'; // # registered users
$lang['Registered_user_total'] = 'Wir haben <span class="thick">einen</span> registrierten Benutzer.'; // # registered users
...
$lang['Rules_post_can'] = 'Du <span class="thick">kannst</span> Beiträge in dieses Forum schreiben.';
$lang['Rules_post_cannot'] = 'Du <span class="thick">kannst keine</span> Beiträge in dieses Forum schreiben.';
$lang['Rules_reply_can'] = 'Du <span class="thick">kannst</span> auf Beiträge in diesem Forum antworten.';
$lang['Rules_reply_cannot'] = 'Du <span class="thick">kannst</span> auf Beiträge in diesem Forum <span class="thick">nicht</span> antworten.';
$lang['Rules_edit_can'] = 'Du <span class="thick">kannst</span> deine Beiträge in diesem Forum bearbeiten.';
$lang['Rules_edit_cannot'] = 'Du <span class="thick">kannst</span> deine Beiträge in diesem Forum <span class="thick">nicht</span> bearbeiten.';
$lang['Rules_delete_can'] = 'Du <span class="thick">kannst</span> deine Beiträge in diesem Forum löschen.';
$lang['Rules_delete_cannot'] = 'Du <span class="thick">kannst</span> deine Beiträge in diesem Forum <span class="thick">nicht</span> löschen.';
$lang['Rules_vote_can'] = 'Du <span class="thick">kannst</span> an Umfragen in diesem Forum mitmachen.';
$lang['Rules_vote_cannot'] = 'Du <span class="thick">kannst</span> an Umfragen in diesem Forum <span class="thick">nicht</span> mitmachen.';
$lang['Rules_moderate'] = 'Du <span class="thick">kannst</span> %sdieses Forum moderieren%s.'; // %s replaced by a href links, do not remove!

$lang['No_topics_post_one'] = 'In diesem Forum sind keine Beiträge vorhanden.<br />Klicke auf <span class="thick">Neues Thema</span>, um den ersten Beitrag zu erstellen.';
...
$lang['Search_keywords_explain'] = 'Du kannst <span class="underline">AND</span> benutzen, um Wörter zu definieren, die vorkommen müssen; <span class="underline">OR</span> kannst du benutzen für Wörter, die im Resultat sein können und <span class="underline">NOT</span> für Wörter, die im Ergebnis nicht vorkommen sollen. Das *-Zeichen kannst du als Platzhalter benutzen.';
