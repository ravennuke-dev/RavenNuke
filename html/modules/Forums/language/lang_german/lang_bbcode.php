...
$faq[] = array("Wie erstelle ich fetten, unterstrichenen oder kursiven Text?", "BBCode verwendet Tags, die dir erlauben, das Aussehen deines Textes recht einfach zu verändern. Dies geschieht folgendermaßen: <ul><li>Um einen Text fett darzustellen, umschließe ihn mit <span class='thick'>[b][/b]</span>, z. B. <br /><br /><span class='thick'>[b]</span>Hallo<span class='thick'>[/b]</span><br /><br /> wird zu <span class='thick'>Hallo</span></li><li>Zum Unterstreichen benutzt du <span class='thick'>[u][/u]</span>, zum Beispiel:<br /><br /><span class='thick'>[u]</span>Guten Morgen<span class='thick'>[/u]</span><br /><br />wird zu <span class='underline'>Guten Morgen</span></li><li>Um kursiv zu schreiben, benutzt du <span class='thick'>[i][/i]</span>, z. B.<br /><br />Das ist <span class='thick'>[i]</span>Toll!<span class='thick'>[/i]</span><br /><br />würde so aussehen: Das ist <span class='italic'>Toll!</span></li></ul>");
$faq[] = array("Wie verändere ich die Schriftfarbe oder Größe?", "Um die Farbe oder Größe deines Textes zu ändern, kannst du die folgenden Tags benutzen. Bedenke jedoch, dass das Resultat auf den Browser des jeweiligen Benutzers ankommt: <ul><li>Um einen Text in einer bestimmten Farbe darzustellen, umschließe ihn mit <span class='thick'>[color=][/color]</span>. Du kannst entweder einen allgemeinen Farbnamen angeben (z. B. red, blue, yellow, usw.) oder den Hexadezimalcode, z. B. #FFFFFF, #000000. Um beispielsweise einen roten Text zu schreiben, könntest du Folgendes schreiben:<br /><br /><span class='thick'>[color=red]</span>Hallo!<span class='thick'>[/color]</span><br /><br />oder<br /><br /><span class='thick'>[color=#FF0000]</span>Hallo!<span class='thick'>[/color]</span>, <br /><br />beides ergibt <span style=\"color:red\">Hallo!</span></li><li>Das Ändern der Textgröße geschieht ähnlich, benutze dazu den Tag <span class='thick'>[size=][/size]</span>. Dieser Tag hängt vom Style ab, das du benutzt. Für gewöhnlich wird die Textgröße als Zahlenwert eingegeben, der die Höhe in Pixel angibt, beginnend mit 1 (so klein, du wirst es kaum sehen) bis zu 29 (riesengroß). Zum Beispiel:<br /><br /><span class='thick'>[size=9]</span>KLEIN<span class='thick'>[/size]</span><br /><br />wird grundsätzlich <span style=\"font-size:9px\">KLEIN</span><br /><br />wohingegen:<br /><br /><span class='thick'>[size=24]</span>RIESIG!<span class='thick'>[/size]</span><br /><br />zu <span style=\"font-size:24px\">RIESIG!</span> wird.</li></ul>");
$faq[] = array("Kann ich verschiedene Tags kombinieren?", "Natürlich geht das, ein Text, der gesehen werden soll, könnte beispielsweise so aussehen: <br /><br /><span class='thick'>[size=18][color=red][b]</span>SCHAU MICH AN<span class='thick'>[/b][/color][/size]</span><br /><br />ergibt <span style=\"color:red;font-size:18px\"><span class='thick'>SCHAU MICH AN!</span></span><br /><br />Es ist nicht zu empfehlen, größere Mengen Text so aussehen zu lassen! Denk daran, es ist deine Aufgabe, dafür zu sorgen, dass alle Tags auch wieder richtig geschlossen werden. Das hier zum Beispiel geht nicht: <br /><br /><span class='thick'>[b][u]</span>Das ist falsch<span class='thick'>[/b][/u]</span>");

$faq[] = array("--","Zitate und Code-Angaben");
$faq[] = array("Zitate in Antworten verwenden", "Es gibt zwei Möglichkeiten, einen Text zu zitieren.<ul><li>Wenn du die Zitatfunktion zum Antworten auf einen Beitrag verwendest, wirst du merken, dass der zitierte Text in <span class='thick'>[quote=\"\"][/quote]</span>-Tags steht. So ist es dir möglich, den Text des Benutzers, oder wo auch immer du ihn her hast, wortgetreu wiederzugeben! Ein Beispiel: Um einen Teil des Textes zu zitieren, den Herr Meier geschrieben hat, würdest du schreiben:<br /><br /><span class='thick'>[quote=\"Herr Meier\"]</span>Der Text von Herrn Meier würde hier erscheinen<span class='thick'>[/quote]</span><br /><br />Der Text 'Herr Meier schrieb:' erscheint automatisch vor dem Zitat. Bedenke, dass du die Zeichen \"\" um den Autorennamen schreiben <span class='thick'>musst</span>, sie dienen nicht nur der Verschönerung.</li><li>Mit der zweiten Möglichkeit erstellst du ein blindes Zitat. Um dies durchzuführen, schließe den Text in <span class='thick'>[quote][/quote]</span>-Tags ein. Wenn du dir den Beitrag dann anschaust, wird einfach nur 'Zitat:' vor dem Beitrag angezeigt.</li></ul>");
$faq[] = array("Code-Angaben", "Wenn du den Teil eines Codes oder etwas, was einfach eine fixe Länge hat, ausgeben möchtest, solltest du den Text in <span class='thick'>[code][/code]</span>-Tags setzen, z. B <br /><br /><span class='thick'>[code]</span>echo \"Dies ist ein Code\";<span class='thick'>[/code]</span><br /><br />Alle Formatierungen, die du in diesen <span class='thick'>[code][/code]</span>-Tags verwendest, werden nachher nicht ausgeführt.");

$faq[] = array("--","Listenerstellung");
$faq[] = array("Eine ungeordnete Liste einfügen", "BBCode unterstützt zwei Typen von Listen, geordnete und ungeordnete. Sie sind im Wesentlichen die gleichen Listen wie ihre Gegenstücke in der HTML-Umgebung. Eine ungeordnete Liste zeigt jedes Objekt in der Liste an, alle mit einem Bullet-Symbol davor. Um eine ungeordnete Liste zu erstellen, benutze die <span class='thick'>[list][/list]</span>-Tags und gib jeden Punkt innerhalb der Liste an, indem du einen <span class='thick'>[*]</span> nutzt. Um zum Beispiel deine Lieblingsfarben aufzuzählen, könntest du schreiben:<br /><br /><span class='thick'>[list]</span><br /><span class='thick'>[*]</span>Rot<br /><span class='thick'>[*]</span>Blau<br /><span class='thick'>[*]</span>Gelb<br /><span class='thick'>[/list]</span><br /><br />Das würde folgende Liste ergeben: <ul><li>Rot</li><li>Blau</li><li>Gelb</li></ul>");
$faq[] = array("Eine geordnete Liste einfügen", "Die zweite Listenart, die geordnete Liste, gibt dir die Möglichkeit, anzugeben, was vor jedem Punkt steht. Um eine geordnete Liste zu erstellen, benutzt du den <span class='thick'>[list=1][/list]</span>-Tag, um eine nummerierte Liste zu erstellen, oder alternativ <span class='thick'>[list=a][/list]</span> für eine alphabetische Liste. Genau wie der bei ungeordneten Liste werden die Punkte mit dem <span class='thick'>[*]</span> spezifiziert. Zum Beispiel:<br /><br /><span class='thick'>[list=1]</span><br /><span class='thick'>[*]</span>In den Laden gehen<br /><span class='thick'>[*]</span>Einen neuen Computer kaufen<br /><span class='thick'>[*]</span>Den Computer verfluchen, wenn er nicht mehr geht<br /><span class='thick'>[/list]</span><br /><br />ergibt das Folgende:<ol type=\"1\"><li>In den Laden gehen</li><li>Einen neuen Computer kaufen</li><li>Den Computer verfluchen, wenn er nicht mehr geht</li></ol>Für eine alphabetische Liste wiederum würdest du das Folgende eingeben:<br /><br /><span class='thick'>[list=a]</span><br /><span class='thick'>[*]</span>Die erste Möglichkeit<br /><span class='thick'>[*]</span>Die zweite Möglichkeit<br /><span class='thick'>[*]</span>Die dritte Möglichkeit<br /><span class='thick'>[/list]</span><br /><br />was<ol type=\"a\"><li>Die erste Möglichkeit</li><li>Die zweite Möglichkeit</li><li>Die dritte Möglichkeit</li>ergibt</ol>");

$faq[] = array("--", "Links erstellen");
$faq[] = array("Das Linken zu einer Site", "phpBB BBCode unterstützt eine Menge verschiedener Möglichkeiten, wie man Internet-Adressen (URLs) einfügen kann.<ul><li>Die erste Möglichkeit ist die Verwendung des<span class='thick'>[url=][/url]</span>-Tag. Was auch immer du hinter das = Zeichen schreibst, wird als Inhalt der URL gewertet. Ein Beispiel: einen Link zu phpBB.com erstellst du so:<br /><br /><span class='thick'>[url=http://www.phpbb.com/]</span>Besucht phpBB!<span class='thick'>[/url]</span><br /><br />Das würde den folgenden Link erstellen: <a href=\"http://www.phpbb.com/\" target=\"_blank\">Besucht phpBB!</a>. Du wirst bemerken, dass sich der Link in einem neuen Fenster öffnet, so dass der Benutzer weiter im Forum surfen kann, sofern er dies wünscht.</li><li>Falls du möchtest, dass die URL automatisch als Link angezeigt wird, kannst du das folgendermaßen schreiben:<br /><br /><span class='thick'>[url]</span>http://www.phpbb.com/<span class='thick'>[/url]</span><br /><br />Dies wird den folgenden Link erzeugen: <a href=\"http://www.phpbb.com/\" target=\"_blank\">http://www.phpbb.com/</a></li><li>Zusätzlich verfügt phpBB über die so genannten <span class='italic'>Magic Links</span>, was automatisch korrekt angegebene URLs in Links umwandelt, ohne dass du Tags schreiben musst. Wenn du zum Beispiel www.phpbb.com in einen Beitrag schreibst, wird daraus automatisch <a href=\"http://www.phpbb.com/\" target=\"_blank\">www.phpbb.com</a>, wenn jemand die Nachricht liest.</li><li>Dies funktioniert übrigens auch mit E Mail-Adressen, du kannst entweder eine Adresse gesondert eingeben, z. B.:<br /><br /><span class='thick'>[email]</span>webmaster@phpbb.com<span class='thick'>[/email]</span><br /><br />was das Folgende ergibt <a href=\"mailto:webmaster@phpbb.com\">webmaster@phpbb.com</a> oder du schreibst einfach webmaster@phpbb.com in deinen Beitrag und es wird automatisch in einen Link umgewandelt.</li></ul>Wie die meisten anderen BBCode-Tags, kannst du auch den URL-Tag mit anderen Tags kombinieren, z. B. <span class='thick'>[img][/img]</span> (siehe nächsten Punkt), <span class='thick'>[b][/b]</span>, usw. Es ist wie immer deine Aufgabe, dass alle geöffneten Tags auch wieder richtig geschlossen werden, z. B.<br /><br /><span class='thick'>[url=http://www.phpbb.com/][img]</span>http://www.phpbb.com/images/phplogo.gif<span class='thick'>[/url][/img]</span><br /><br />ist <span class='underline'>nicht</span> richtig und wird einen Fehler in deinem Beitrag auslösen.");

$faq[] = array("--", "Bilder in Beiträgen anzeigen");
$faq[] = array("Ein Bild einfügen", "Der phpBB BBCode unterstützt ebenfalls das Einfügen von Bildern in Beiträgen. Es gibt zwei wichtige Regeln, was das Anzeigen von Bildern betrifft: Die meisten User finden es einfach furchtbar, wenn endlos Bilder in den Beiträgen stehen (Stichwort Ladezeiten) und zum anderen muss das Bild bereits irgendwo im Internet hochgeladen sein (es bringt also nichts, wenn die Datei nur auf deiner Festplatte liegt, sofern du keinen Webserver hast!). Momentan gibt es noch keine Möglichkeit, Bilder mit Hilfe von phpBB lokal zu speichern (das könnte sich mit der nächsten Version von phpBB 2 natürlich ändern). Um ein Bild anzuzeigen, muss die URL des Bildes mit den <span class='thick'>[img][/img]</span>-Tags umschlossen werden. Zum Beispiel:<br /><br /><span class='thick'>[img]</span>http://www.phpbb.com/images/phplogo.gif<span class='thick'>[/img]</span><br /><br />Wie bei der URL-Erklärung bereits erwähnt, kannst du Bilder in <span class='thick'>[url][/url]</span>-Tags einschließen, wenn du möchtest, z. B. <br /><br /><span class='thick'>[url=http://www.phpbb.com/][img]</span>http://www.phpbb.com/images/phplogo.gif<span class='thick'>[/img][/url]</span><br /><br />würde Folgendes ergeben:<br /><br /><a href=\"http://www.phpbb.com/\" target=\"_blank\"><img src=\"templates/subSilver/images/logo_phpBB_med.gif\" border=\"0\" alt=\"\" /></a><br />");
