...
$faq[] = array("¿Por qué me desconecta automáticamente?", "Si no activa la opción <span class='italic'>Identificarme automáticamente</span>, el foro solo lo mantendrá identificado por un determinado tiempo. Esto previene el uso de su cuenta por otras personas. Para mantenerse identificado, active la opción al momento de identificarse. No se recomienda hacer esto si Ud. accede desde un ordenador compartido, por ej. cyber-café, trabajo, universidad, etc.");
$faq[] = array("¿Cómo evito que mi nombre de usuario aparezca en las listas de usuarios conectados?", "En su perfil encontrará una opción de <span class='italic'>Ocultar mi estado de conexión</span>; si activa esta opción solo podrá ser visto por administradores y Ud. mismo. Se le contará como usuario oculto.");
$faq[] = array("¡Perdí mi contraseña!", "¡No se altere! Si bien su contraseña no se le puede enviar puede ser cambiada. Para esto vaya a Conectarse y pulse en <span class='underline'>¡He olvidado mi contraseña!</span>. Siga las instrucciones y podrá volver a identificarse casi de inmediato.");
$faq[] = array("¡Me registré pero no puedo identificarme!", "Primero verifique que está ingresando el nombre de usuario y contraseña correctos. Si están bien entonces verifique estas posibilidades: si está habilitado el soporte para COPPA y Ud. pulsó en <span class='underline'>tengo menos de 13 años</span> mientras se registraba entonces deberá seguir las instrucciones que recibió. Si este no es el caso, entonces su cuenta debe necesitar activación. Revise su correo y vea las instrucciones de activación, algunos foros dejan que sus usuarios activen sus cuentas y otros requieren la activación por parte del administrador. Si no recibió un correo, verifique que su correo sea correcto. Una de las razones por las que se pide activación es para evitar que usuarios anónimos abusen del foro. Si ninguna de estas descripciones concuerda con su problema, contacte con el administrador del foro.");
...
$faq[] = array("¿Cómo cambio mi configuración?", "Todos sus datos y configuraciones (si está registrado) están archivados en nuestra base de datos. Para modificarlos pulse en el enlace de <span class='underline'>Perfil</span>, generalmente se encuentra en la parte de arriba de cada página.");
...
$faq[] = array("¿Cómo creo un mensaje en un Tema o en un foro?", "Fácil -- pulse en el botón correspondiente cuando esté en un foro o en un tema. Puede que necesite registrarse para poder crear mensajes. Los permisos que tiene en cada lugar del foro están listados en la parte inferior de cada página (<span class='italic'> Puede crear mensajes. Puede hacer encuestas..</span>)");
$faq[] = array("¿Cómo modifico o borro un mensaje?", "A menos que sea administrador o moderador del foro, solo puede borrar o modificar los mensajes que haya ingresado Ud. mismo. Puede modificar un mensaje pulsando en <span class='italic'>Editar</span>. Si alguien ya ha respondido a su mensaje, encontrará un pequeño texto en el suyo diciendo que ha sido modificado y las veces que lo ha hecho. No aparece si fue un moderador o el administrador el que lo modificó (la mayoria de las veces se deja un mensaje aclaratorio).");
$faq[] = array("¿Cómo adoso mi firma a mis mensajes?", "Para adosar una firma en sus mensajes primero tiene que crear una firma personalizada. Esto se hace modificando su perfil. Una vez creada puede activar la opción <span class='italic'>Agregar firma</span> cuando ingrese un mensaje. También puede activar la opción para que siempre se agregue su firma a los mensajes (esta opción está en su perfil) y puede evitar que se adose su firma a algún mensaje en particular al crearlo.");
$faq[] = array("¿Cómo creo una encuesta?", "Crear una encuesta es fácil -- cuando inicia un nuevo tema (o modifica el primer mensaje de un tema) verá la opción <span class='italic'>Crear una encuesta</span> en la parte inferior del formulario de mensaje. Si no ve esta opción probablemente las encuestas estén desactivadas o no tiene permisos para crearlas. Debe introducir un título para la encuesta y por lo menos 2 opciones de votación -- para agregar una opción escriba una y pulse en <span class='italic'>Agregar opción</span>. También puede limitar la encuesta por tiempo (0 [cero] para que no tenga límite de tiempo). También habrá un límite de opciones a agregar que es establecida por defecto por el administrador.");
...
$faq[] = array("¿Qué son los Moderadores?", "Los Moderadores usuarios (o grupos de usuarios) cuyo trabajo es mantener el funcionamiento normal del foro día a día. Tienen el poder de modificar o borrar mensajes, bloquear o desbloquear, mover y separar temas en el foro donde son Moderadores. Por lo general los Moderadores están ahí para evitar que los usuarios publiquen mensajes que estén <span class='italic'>fuera de tema (off topic)</span> o que se abuse de material ofensivo en el foro. NOTA: <span class='italic'>Off topic o Fuera de tema</span> significa desviarse del motivo o tema original de la conversación, es algo muy subjetivo definir si sucede o no y por ende los Moderadores son seleccionados (por lo general) cuidadosamente. Ha de respetarse sus decisiones sobre esta cuestión.");
...
$faq[] = array("¿Cómo me uno a un Grupo de Usuarios?", "Para unirse a un Grupo de Usuarios, pulse en el enlace <span class='italic'>Grupos de Usuarios</span> y podrá ver todos los Grupos. No todos son de <span class='italic'>Acceso libre</span> -- algunos están cerrados y otros pueden tener usuarios ocultos. Si el Grupo está abierto Ud. puede requerir ser unido al grupo pulsando en el botón apropiado. El moderador del grupo deberá aprobar su petición; pueden preguntarle porqué quiere unirse al grupo. Por favor, no moleste a los moderadores de grupo si rechazan su petición -- tendrán sus motivos.");
