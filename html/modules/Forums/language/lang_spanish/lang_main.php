...
$lang['Page_of'] = 'Página <span class="thick">%d</span> de <span class="thick">%d</span>'; // Replaces with: Page 1 of 2 for example
...
$lang['Online_users_zero_total'] = 'En total hay <span class="thick">0</span> usuarios conectados :: ';
$lang['Online_users_total'] = 'En total hay <span class="thick">%d</span> usuarios conectados :: ';
$lang['Online_user_total'] = 'En total hay <span class="thick">%d</span> usuario conectado :: ';
...
$lang['Record_online_users'] = 'El nº máximo de usuarios conectados a la vez fue de <span class="thick">%s</span> el %s'; // first %s = number of users, second %s is the date.
...
// Stats block text
//
$lang['Posted_articles_zero_total'] = 'Nuestros usuarios han publicado en total <span class="thick">0</span> mensajes'; // Number of posts
$lang['Posted_articles_total'] = 'Nuestros usuarios han publicado en total <span class="thick">%d</span> mensajes'; // Number of posts
$lang['Posted_article_total'] = 'Nuestros usuarios han publicado en total <span class="thick">%d</span> mensaje'; // Number of posts
$lang['Registered_users_zero_total'] = 'Tenemos <span class="thick">0</span> usuarios registrados'; // # registered users
$lang['Registered_users_total'] = 'Tenemos <span class="thick">%d</span> usuarios registrados'; // # registered users
$lang['Registered_user_total'] = 'Tenemos <span class="thick">%d</span> usuario registrado'; // # registered users
$lang['Newest_user'] = 'El último usuario registrado es <span class="thick">%s%s%s</span>'; // a href, username, /a
...
$lang['Topic_Announcement'] = '<span class="thick">Anuncio:</span>';
$lang['Topic_Sticky'] = '<span class="thick">Nota (PostIt):</span>';
$lang['Topic_Moved'] = '<span class="thick">Movido:</span>';
$lang['Topic_Poll'] = '<span class="thick">[ Encuesta ]</span>';
...
$lang['Rules_post_can'] = '<span class="thick">Puede</span> crear mensajes';
$lang['Rules_post_cannot'] = '<span class="thick">No puede</span> crear mensajes';
$lang['Rules_reply_can'] = '<span class="thick">Puede</span> responder temas';
$lang['Rules_reply_cannot'] = '<span class="thick">No puede</span> responder temas';
$lang['Rules_edit_can'] = '<span class="thick">Puede</span> editar sus mensajes';
$lang['Rules_edit_cannot'] = '<span class="thick">No puede</span> editar sus mensajes';
$lang['Rules_delete_can'] = '<span class="thick">Puede</span> borrar sus mensajes';
$lang['Rules_delete_cannot'] = '<span class="thick">No puede</span> borrar sus mensajes';
$lang['Rules_vote_can'] = '<span class="thick">Puede</span> votar en encuestas';
$lang['Rules_vote_cannot'] = '<span class="thick">No puede</span> votar en encuestas';
$lang['Rules_moderate'] = '<span class="thick">Puede</span> %smoderar este foro%s'; // %s replaced by a href links, do not remove!

$lang['No_topics_post_one'] = 'No hay mensajes en este foro.<br />Pulse en <span class="thick">Publicar Nuevo Tema</span> en esta página para crear uno.';
...
$lang['Guest'] = 'Invitado';
$lang['Post_subject'] = '<span class="thick">Título del mensaje</span>';
...
$lang['HTML_is_ON'] = 'HTML está <span class="underline">ON</span>';
$lang['HTML_is_OFF'] = 'HTML está <span class="underline">OFF</span>';
$lang['BBCode_is_ON'] = '%sBBCode%s está <span class="underline">ON</span>'; // %s are replaced with URI pointing to FAQ
$lang['BBCode_is_OFF'] = '%sBBCode%s está <span class="underline">OFF</span>';
$lang['Smilies_are_ON'] = 'Emoticonos están <span class="underline">ON</span>';
$lang['Smilies_are_OFF'] = 'Emoticonos están <span class="underline">OFF</span>';
...
$lang['Agree_under_13'] = 'Estoy de acuerdo con estos términos y condiciones y tengo <span class="thick">menos de</span> 13 años de edad';
$lang['Agree_over_13'] = 'Estoy de acuerdo con estos términos y condiciones y tengo <span class="thick">más de</span> o <span class="thick">exactamente</span> 13 de edad';
...
$lang['Search_keywords_explain'] = 'Puede usar <span class="underline">AND</span> para definir palabras que deben estar en los resultados, <span class="underline">OR</span> para definir palabras que podrían estar en los resultados y <span class="underline">NOT</span> para definir palabras que NO deberían estar en los resultados. Use * como comodín para búscar partes de una palabra';
...
$lang['Auth_Anonymous_Users'] = '<span class="thick">usuarios anónimos</span>';
$lang['Auth_Registered_Users'] = '<span class="thick">usuarios registrados</span>';
$lang['Auth_Users_granted_access'] = '<span class="thick">usuarios con permisos especiales</span>';
$lang['Auth_Moderators'] = '<span class="thick">moderadores</span>';
$lang['Auth_Administrators'] = '<span class="thick">administradores</span>';
