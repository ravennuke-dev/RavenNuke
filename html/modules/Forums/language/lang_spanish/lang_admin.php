...
$lang['Admin_intro'] = 'Gracias por elegir phpBB como la solución para su foro. Esta pantalla le dará una síntesis de las estadísticas de su foro. Puede volver a esta pantalla pulsando en el enlace <span class="underline">Índice de Administración</span> en el panel izquierdo. Para volver al índice del foro pulse en el logo de phpBB, también en el panel izquierdo. El resto de los enlaces en el panel izquierdo de esta pantalla le permitirán controlar todos los aspectos de su foro. Cada pantalla tendrá instrucciones de cómo usar cada herramienta.';
...
$lang['Restore_explain'] = 'Esta acción realizará una restauración completa de todas las tablas desde un archivo previamente guardado. Si su servidor lo soporta, puede subir un archivo de texto comprimido con Gzip y automáticamente será descomprimido. <span class="thick">ATENCION</span>: Esta acción sobrescribirá los datos existentes. La restauración puede llevar un largo tiempo para procesar, dependiendo del tamaño de la copia de seguridad (backup), manténgase en esta página hasta que se complete el proceso.';
...
$lang['Version_not_up_to_date'] = 'Su versión de phpBB parece <span class="thick">no</span> ser la más actual. Hay actualizaciones disponibles para su versión de phpBB, visite <a href="http://www.phpbb.com/downloads.php" target="_new">http://www.phpbb.com/downloads.php</a> para obtener la última versión.';
$lang['Latest_version_info'] = 'La última versión disponible es la <span class="thick">phpBB %s</span>.';
$lang['Current_version_info'] = 'usted está utilizando <span class="thick">phpBB %s</span>.';
