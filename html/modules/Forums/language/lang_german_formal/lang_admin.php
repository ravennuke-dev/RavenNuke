...
$lang['Backup'] = 'Backup';
$lang['Restore_explain'] = 'Hiermit werden alle phpBB Tabellen aus einer Datei wiederhergestellt. Falls es Ihr Server unterstützt, können Sie auch einen GZip-komprimierten Text hochladen - er wird automatisch dekomprimiert! <span class="thick">ACHTUNG</span>: Es werden alle existierenden Daten überschrieben. Der Vorgang wird einige Zeit dauern, bitte verlassen Sie diese Seite nicht, bis er abgeschlossen wurde.';
...
$lang['Version_not_up_to_date'] = 'Ihr Forum ist wahrscheinlich <span class="thick">nicht</span> auf dem neuesten Stand. Es sind Updates für Ihre phpBB-Version verfügbar, bitte besuchen Sie <a href="http://www.phpbb.com/downloads.php" target="_blank">http://www.phpbb.com/downloads.php</a>, um die aktuellste Version zu erhalten.';
$lang['Latest_version_info'] = 'Die neueste verfügbare Version ist <span class="thick">phpBB %s</span>.';
$lang['Current_version_info'] = 'Sie verwenden <span class="thick">phpBB %s</span>.';
