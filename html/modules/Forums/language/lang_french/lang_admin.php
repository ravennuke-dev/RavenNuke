...
$lang['Admin_intro'] = 'Nous vous remercions d’avoir sélectionné phpBB comme solution pour votre forum. Cet écran vous donne un aperçu rapide des diverses statistiques de votre forum. Vous pouvez retourner sur cette page en cliquant sur le lien <span class="underline">Index de l’administration</span> dans le panneau de gauche. Pour retourner à l’index de votre forum, cliquez sur le logo phpBB qui est également situé dans le panneau de gauche. Les autres liens situés sur le volet à gauche de cet écran vous permettront de contrôler tous les aspects de votre forum. Chaque page contiendra des instructions sur l’utilisation des outils disponibles.';
...
$lang['Restore_explain'] = 'Cela exécutera une restauration complète de toutes les tables de phpBB à partir d’un fichier de sauvegarde. Si votre serveur le supporte, vous pouvez utiliser un fichier texte compressé en GZip qui sera automatiquement décompressé. <span class="thick">ATTENTION :</span> cela écrasera toutes les données existantes. La restauration est un processus pouvant prendre beaucoup de temps, veuillez ne pas vous déplacer de la page avant que l’opération soit terminée.';
$lang['Backup_explain'] = 'Vous pouvez sauvegarder ici toutes les données relatives à votre forum phpBB. Si vous avez créé des tables additionnelles personnalisées dans la même base de données et que vous souhaitez les sauvegarder, veuillez saisir leurs noms, séparés par une virgule, dans la boîte de texte <span class="underline">Tables additionnelles</span> ci-dessous. Si votre serveur le supporte, vous pouvez également compresser votre fichier au format GZip afin de réduire sa taille avant de le télécharger.';
...
$lang['Version_not_up_to_date'] = 'Votre installation ne semble <span class="thick">pas</span> à jour. Des mises à jour sont disponibles, veuillez vous rendre sur <a href="http://www.phpbb.com/downloads.php" target="_new">http://www.phpbb.com/downloads.php</a> ou sur <a href="http://www.phpbb.fr/" target="_new">http://www.phpbb.fr/</a> afin d’obtenir la dernière version de phpBB.';
$lang['Latest_version_info'] = 'La dernière version disponible est <span class="thick">phpBB %s</span>.';
$lang['Current_version_info'] = 'Vous utilisez actuellement <span class="thick">phpBB %s</span>.';
