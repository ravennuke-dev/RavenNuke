...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr>
		<th class="thHead" colspan="2" height="25 thick">{L_SEND_EMAIL_MSG}</th>
	</tr>
	<tr>
		<td class="row1" width="22%"><span class="gen thick">{L_RECIPIENT}</span></td>
		<td class="row2" width="78%"><span class="gen thick">{USERNAME}</span> </td>
	</tr>
	<tr>
		<td class="row1" width="22%"><span class="gen thick">{L_SUBJECT}</span></td>
	...
	<tr>
		<td class="row1" valign="top"><span class="gen thick">{L_MESSAGE_BODY}</span><br /><span class="gensmall">{L_MESSAGE_BODY_DESC}</span></td>
	...
	<tr>
		<td class="row1" valign="top"><span class="gen thick">{L_OPTIONS}</span></td>
