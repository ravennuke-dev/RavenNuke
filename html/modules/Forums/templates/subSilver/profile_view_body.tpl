...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  ...
  <tr> 
	<td class="catLeft" width="40%" height="28" align="center"><span class="gen thick">{L_AVATAR}</span></td>
	<td class="catRight" width="60%"><span class="gen thick">{L_ABOUT_USER}</span></td>
  </tr>
  <tr> 
	...
	<td class="row1" rowspan="3" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
		<tr> 
		  ...
		  <td width="100%"><span class="gen thick">{JOINED}</span></td>
		</tr>
		<tr> 
		  <td valign="top" align="right" nowrap="nowrap"><span class="gen">{L_TOTAL_POSTS}:&nbsp;</span></td>
		  <td valign="top"><span class="gen thick">{POSTS}</span><br /><span class="genmed">[{POST_PERCENT_STATS} / {POST_DAY_STATS}]</span> <br /><span class="genmed"><a href="{U_SEARCH_USER}" class="genmed">{L_SEARCH_USER_POSTS}</a></span></td>
		</tr>
		<tr> 
		  <td valign="middle" align="right" nowrap="nowrap"><span class="gen">{L_LOCATION}:&nbsp;</span></td>
		  <td><span class="gen thick">{LOCATION}</span></td>
		</tr>
		<tr> 
		  <td valign="middle" align="right" nowrap="nowrap"><span class="gen">{L_WEBSITE}:&nbsp;</span></td>
		  <td><span class="gen thick">{WWW}</span></td>
		</tr>
		<tr> 
		  <td valign="middle" align="right" nowrap="nowrap"><span class="gen">{L_OCCUPATION}:&nbsp;</span></td>
		  <td><span class="gen thick">{OCCUPATION}</span></td>
		</tr>
		<tr> 
		  <td valign="top" align="right" nowrap="nowrap"><span class="gen">{L_INTERESTS}:</span></td>
		  <td> <span class="gen thick">{INTERESTS}</span></td>
		</tr>
<!-- BEGIN switch_upload_limits -->
		<tr> 
			...
			<td> 
				...
				<span class="genmed thick">[{UPLOADED} / {QUOTA} / {PERCENT_FULL}]</span> <br />
...
<!-- END switch_upload_limits -->		
  ...
  <tr> 
	<td class="catLeft" align="center" height="28"><span class="gen thick">{L_CONTACT} {USERNAME} </span></td>
  </tr>
  <tr> 
	<td class="row1" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
		<tr> 
		  <td valign="middle" align="right" nowrap="nowrap"><span class="gen">{L_EMAIL_ADDRESS}:</span></td>
		  <td class="row1" valign="middle" width="100%"><span class="gen thick">{EMAIL_IMG}</span></td>
		</tr>
		<tr> 
		  <td valign="middle" nowrap="nowrap" align="right"><span class="gen">{L_PM}:</span></td>
		  <td class="row1" valign="middle"><span class="gen thick">{PM_IMG}</span></td>
		</tr>
		<tr> 
