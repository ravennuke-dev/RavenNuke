...
<tr>
  <td class="row2" colspan="2"><br clear="all" />
	<table cellspacing="0" cellpadding="4" border="0" align="center">
	  <tr>
		<td colspan="4" align="center"><span class="gen thick">{POLL_QUESTION}</span></td>
	  </tr>
	  <tr>
		<td align="center">
		  <table cellspacing="0" cellpadding="2" border="0">
			...
			<tr>
			  ...
			  <td align="center"><span class="gen thick">&nbsp;{poll_option.POLL_OPTION_PERCENT}&nbsp;</span></td>
	  ...
	  <tr>
		<td colspan="4" align="center"><span class="gen thick">{L_TOTAL_VOTES} : {TOTAL_VOTES}</span></td>
	  </tr>
	</table>
	<br clear="all" />
  </td>
