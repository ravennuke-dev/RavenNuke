            ...
            <tr>
				<td class="row1"><span class="gen thick">{L_POLL_QUESTION}</span></td>
            ...
            <tr>
				<td class="row1"><span class="gen thick">{L_POLL_OPTION}</span></td>
            ...
            <tr>
				<td class="row1"><span class="gen thick">{L_POLL_LENGTH}</span></td>
				<td class="row2"><span class="genmed"><input type="text" name="poll_length" size="3" maxlength="3" class="post" value="{POLL_LENGTH}" /></span>&nbsp;<span class="gen thick">{L_DAYS}</span> &nbsp; <span class="gensmall">{L_POLL_LENGTH_EXPLAIN}</span></td>
			</tr>
			<!-- BEGIN switch_poll_delete_toggle -->
            <tr>
				<td class="row1"><span class="gen thick">{L_POLL_DELETE}</span></td>
