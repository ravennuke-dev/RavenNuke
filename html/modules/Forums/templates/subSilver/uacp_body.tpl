...
<div class="text-center thick">{L_UACP} :: {USERNAME}</div>
...
<form method="post" name="attach_list" action="{S_MODE_ACTION}">
	...
	<tr>
		<td align="right" valign="top" nowrap="nowrap"><span class="gensmall thick"><a href="javascript:select_switch(true);" class="gensmall">{L_MARK_ALL}</a> :: <a href="javascript:select_switch(false);" class="gensmall">{L_UNMARK_ALL}</a></span></td>
	</tr>
	</table>
