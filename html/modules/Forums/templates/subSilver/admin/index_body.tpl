...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <tr>
	...
	<td class="row2 thick">{POSTS_PER_DAY}</td>
  </tr>
  <tr>
	...
	<td class="row2 thick">{TOPICS_PER_DAY}</td>
  </tr>
  <tr>
