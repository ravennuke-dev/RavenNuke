...
<form method="post" action="{S_FORUM_ACTION}"><table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
	...
	<!-- BEGIN catrow -->
	<tr>
		<td class="catLeft" colspan="3"><span class="cattitle thick"><a href="{catrow.U_VIEWCAT}">{catrow.CAT_DESC}</a></span></td>
	...
	<tr>
		...
		ERROR
		<!-- END switch_error -->
		<a href="{catrow.forumrow.U_VIEWFORUM}" target="_blank">{catrow.forumrow.FORUM_NAME}</a></span><br />
		<span class="gensmall">
		<!-- BEGIN switch_attached_forum -->
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<!-- END switch_attached_forum -->
