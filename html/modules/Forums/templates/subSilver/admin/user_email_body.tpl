...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr> 
	  <td class="row1" align="right" class="thick">{L_RECIPIENTS}</td>
	  <td class="row2" align="left">{S_GROUP_SELECT}</td>
	</tr>
	<tr> 
	  <td class="row1" align="right" class="thick">{L_EMAIL_SUBJECT}</td>
	...
	<tr> 
	  <td class="row1" align="right" valign="top"> <span class="gen" class="thick">{L_EMAIL_MSG}</span> 
