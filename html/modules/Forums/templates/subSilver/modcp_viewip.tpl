...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
	<td class="catHead" height="28"><span class="cattitle thick">{L_THIS_POST_IP}</span></td>
  </tr>
  <tr> 
	<td class="row1"> 
  ...
  <tr> 
	<td class="catHead" height="28"><span class="cattitle thick">{L_OTHER_USERS}</span></td>
  </tr>
  <!-- BEGIN userrow -->
  <tr> 
  ...
  <!-- END userrow -->
  <tr> 
	<td class="catHead" height="28"><span class="cattitle thick">{L_OTHER_IPS}</span></td>
  </tr>
  <!-- BEGIN iprow -->
  <tr> 
