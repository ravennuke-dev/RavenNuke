...
<!-- BEGIN attach -->
	...
	<tr>
		<td width="100%" class="attachheader" align="center"><span class="gen thick">{postrow.attach.denyrow.L_DENIED}</span></td>
	</tr>
	</table>
	<div align="center"><hr width="95%" /></div>
	<!-- END denyrow -->
	...
	<table width="95%" border="1" cellpadding="2" cellspacing="0" class="attachtable" align="center">
	<tr>
		<td width="100%" colspan="2" class="attachheader" align="center"><span class="gen thick">{postrow.attach.cat_stream.DOWNLOAD_NAME}</span></td>
	</tr>
	<tr>
	...
	<table width="95%" border="1" cellpadding="2" cellspacing="0" class="attachtable" align="center">
	<tr>
		<td width="100%" colspan="2" class="attachheader" align="center"><span class="gen thick">{postrow.attach.cat_swf.DOWNLOAD_NAME}</span></td>
	</tr>
	<tr>
		<td width="15%" class="attachrow"><span class="genmed">&nbsp;{L_DESCRIPTION}:</span></td>
		<td width="75%" class="attachrow">
	...
	<table width="95%" border="1" cellpadding="2" cellspacing="0" class="attachtable" align="center">
	<tr>
		<td width="100%" colspan="2" class="attachheader" align="center"><span class="gen thick">{postrow.attach.cat_images.DOWNLOAD_NAME}</span></td>
	</tr>
	<tr>
		<td width="15%" class="attachrow"><span class="genmed">&nbsp;{L_DESCRIPTION}:</span></td>
		<td width="75%" class="attachrow">
	...
	<table width="95%" border="1" cellpadding="2" cellspacing="0" class="attachtable" align="center">
	<tr>
		<td width="100%" colspan="2" class="attachheader" align="center"><span class="gen thick">{postrow.attach.cat_thumb_images.DOWNLOAD_NAME}</span></td>
	</tr>
	<tr>
		<td width="15%" class="attachrow"><span class="genmed">&nbsp;{L_DESCRIPTION}:</span></td>
		<td width="75%" class="attachrow">
	...
	<table width="95%" border="1" cellpadding="2" cellspacing="0" class="attachtable" align="center">
	<tr>
		<td width="100%" colspan="3" class="attachheader" align="center"><span class="gen thick">{postrow.attach.attachrow.DOWNLOAD_NAME}</span></td>
	</tr>
	<tr>
		<td width="15%" class="attachrow"><span class="genmed">&nbsp;{L_DESCRIPTION}:</span></td>
		<td width="75%" class="attachrow">
		...
		<td rowspan="4" align="center" width="10%" class="attachrow">{postrow.attach.attachrow.S_UPLOAD_IMAGE}<br /><a href="{postrow.attach.attachrow.U_DOWNLOAD_LINK}" {postrow.attach.attachrow.TARGET_BLANK} class="genmed"><span class="thick">{L_DOWNLOAD}</span></a></td>
	</tr>
	<tr>
