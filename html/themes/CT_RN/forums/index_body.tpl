...
<!-- BEGIN catrow -->
<tr>
<td class="cat" colspan="5"><a href="{catrow.U_VIEWCAT}">{catrow.CAT_DESC}</a></td>
</tr>
<!-- BEGIN forumrow -->
<tr>
...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
<tr>
<td class="cat"><a href="{U_VIEWONLINE}">{L_WHO_IS_ONLINE}</a></td>
</tr>
<tr>
...
<tr>
<td class="row1"><span class="gensmall">{L_ONLINE_EXPLAIN}<br />
Powered by <a href="http://www.phpbb.com/" target="_blank">phpBB</a> {PHPBB_VERSION} &copy; 2001-2007 phpBB Group</span></td>
</tr>
</table>
...
<tr>
<td><img src="themes/CT_RN/forums/images/folder_new.gif" alt="{L_NEW_POSTS}" title="{L_NEW_POSTS}" /></td>
<td class="gensmall">{L_NEW_POSTS}</td>
<td>&nbsp;</td>
<td><img src="themes/CT_RN/forums/images/folder.gif" alt="{L_NO_NEW_POSTS}" title="{L_NO_NEW_POSTS}" /></td>
<td class="gensmall">{L_NO_NEW_POSTS}</td>
<td>&nbsp;</td>
<td><img src="themes/CT_RN/forums/images/folder_lock.gif" alt="{L_FORUM_LOCKED}" title="{L_FORUM_LOCKED}" /></td>
