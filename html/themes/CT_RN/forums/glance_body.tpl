...
<table width="{GLANCE_TABLE_WIDTH}" cellpadding="2" cellspacing="0" border="0" class="forumline" height="100%">
    ...
    <!-- END switch_recent_off -->
		...
		<th height="28" align="left">
            <table width="100%" height="28" cellpadding="0" cellspacing="0" border="0">
            <tr><td class="glance" align="left">
                {RECENT_HEADING}
                </th>
        		<td class="glance" align="right">
                    {switch_glance_recent.PREV_URL}&nbsp;&nbsp;{switch_glance_recent.NEXT_URL}&nbsp;&nbsp;
                </th>
            </tr>
            </table>
        </th>
        <th class="thTop" width="100" height="28" align="center" nowrap="nowrap">&nbsp;{L_FORUM}&nbsp;</th>
        <th class="thTop" width="100" align="center" nowrap="nowrap">&nbsp;{L_AUTHOR}&nbsp;</th>
        <th class="thTop" width="50" align="center" nowrap="nowrap">&nbsp;{L_REPLIES}&nbsp;</th>
        <th class="thCornerR" align="center" nowrap="nowrap">&nbsp;{L_LASTPOST}&nbsp;</th>
    </tr>
