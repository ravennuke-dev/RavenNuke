...
<!-- BEGIN switch_attached_list -->
   ...
   <table width="100%" border="0" cellpadding="4" cellspacing="1" class="forumline">
	...
	<tr>
		<td class="row1" align="center" valign="middle" height="38" width="50"><img src="{switch_attached_list.switch_attached_present.FORUM_FOLDER_IMG}" alt="{switch_attached_list.switch_attached_present.L_FORUM_FOLDER_ALT}" title="{switch_attached_list.switch_attached_present.L_FORUM_FOLDER_ALT}" /></td>
