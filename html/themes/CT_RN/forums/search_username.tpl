...
//<![CDATA[
<!--
function refresh_username(combo)
{
	selected_username = combo.options[combo.selectedIndex].value;
...
&nbsp;
<input type="submit" class="button" onclick="refresh_username(this.form.username_list);return false;" name="use" value="{L_SELECT}" />
<br />
