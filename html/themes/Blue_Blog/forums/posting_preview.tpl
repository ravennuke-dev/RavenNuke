...
<tr>
<td class="row1"><img src="themes/Blue_Blog/forums/images/icon_minipost.gif" alt="{L_POST}" title="{L_POST}" width="12" height="9" /><span class="postdetails">{L_POSTED}: {POST_DATE} &nbsp;&nbsp;&nbsp; {L_POST_SUBJECT}: {POST_SUBJECT}</span></td>
</tr>
<tr>
