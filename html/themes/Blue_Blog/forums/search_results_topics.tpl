...
<!-- BEGIN searchresults -->
<tr>
<td class="row1"><img src="{searchresults.TOPIC_FOLDER_IMG}" width="33" height="25" alt="{searchresults.L_TOPIC_FOLDER_ALT}" title="{searchresults.L_TOPIC_FOLDER_ALT}" /></td>
