...
<!-- BEGIN switch_attached_list -->
   ...
   <table width="100%" border="0" cellpadding="4" cellspacing="1" class="forumline">
	...
	<tr>
		...
		<td class="row1" width="75%"><span class="topictitle"><a class="topictitle" href="{switch_attached_list.switch_attached_present.U_VIEWFORUM}">{switch_attached_list.switch_attached_present.FORUM_NAME}</a></span><br /><span class="genmed">{switch_attached_list.switch_attached_present.FORUM_DESC}</span></td>
