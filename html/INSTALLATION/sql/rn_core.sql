...
CREATE TABLE IF NOT EXISTS $prefix.`_links_editorials` ( `linkid` int(11) NOT NULL default '0', `adminid` varchar(60) NOT NULL default '', `editorialtimestamp` datetime NOT NULL default '1000-01-01 00:00:00', `editorialtext` text NOT NULL, `editorialtitle` varchar(100) NOT NULL default '', PRIMARY KEY  (`linkid`) ) ENGINE=MyISAM;
...
CREATE TABLE IF NOT EXISTS $prefix.`_queue` ( `qid` smallint(5) unsigned NOT NULL auto_increment, `uid` mediumint(9) NOT NULL default '0', `uname` varchar(40) NOT NULL default '', `subject` varchar(100) NOT NULL default '', `story` text, `storyext` text NOT NULL, `timestamp` datetime NOT NULL default '1000-01-01 00:00:00', `topic` varchar(20) NOT NULL default '', `alanguage` varchar(30) NOT NULL default '', PRIMARY KEY  (`qid`), KEY `uid` (`uid`), KEY `uname` (`uname`) ) ENGINE=MyISAM;
...
CREATE TABLE IF NOT EXISTS $prefix.`_reviews` ( `id` int(10) NOT NULL auto_increment, `date` date NOT NULL default '1000-01-01', `title` varchar(150) NOT NULL default '', `text` text NOT NULL, `reviewer` varchar(25) default NULL, `email` varchar(60) default NULL, `score` int(10) NOT NULL default '0', `cover` varchar(100) NOT NULL default '', `url` varchar(100) NOT NULL default '', `url_title` varchar(50) NOT NULL default '', `hits` int(10) NOT NULL default '0', `rlanguage` varchar(30) NOT NULL default '', PRIMARY KEY  (`id`) ) ENGINE=MyISAM;
...
CREATE TABLE $prefix.`_gcal_exception` (`id` int(11) NOT NULL auto_increment, `event_id` int(11) NOT NULL, `date` date NOT NULL default '1000-01-01', PRIMARY KEY (`id`), KEY `event_id` (`event_id`), KEY `date` (`date`)) ENGINE=MyISAM;
...
CREATE TABLE $prefix.`_pages` (  `pid` int(10) NOT NULL auto_increment,  `cid` int(10) NOT NULL default '0',  `title` varchar(255) NOT NULL default '',  `subtitle` varchar(255) NOT NULL default '',  `tags` varchar(255) NOT NULL,  `active` int(1) NOT NULL default '0',  `page_header` text NOT NULL,  `text` text NOT NULL,  `page_footer` text NOT NULL,  `signature` text NOT NULL,  `date` datetime NOT NULL default '1000-01-01 00:00:00',  `counter` int(10) NOT NULL default '0',  `clanguage` varchar(30) NOT NULL default '',  `uname` varchar(40) NOT NULL default '',  PRIMARY KEY  (`pid`),  KEY `cid` (`cid`)) ENGINE=MyISAM;
...
CREATE TABLE $prefix.`_newpages` (  `pid` int(10) NOT NULL auto_increment,  `cid` int(10) NOT NULL default '0',  `title` varchar(255) NOT NULL default '',  `subtitle` varchar(255) NOT NULL default '',  `tags` varchar(255) NOT NULL default '',  `page_header` text NOT NULL,  `text` text NOT NULL,  `page_footer` text NOT NULL,  `signature` text NOT NULL,  `uname` varchar(40) NOT NULL default '',  `date` datetime NOT NULL default '1000-01-01 00:00:00',  `clanguage` varchar(30) NOT NULL default '',  PRIMARY KEY  (`pid`),  KEY `cid` (`cid`)) ENGINE=MyISAM;
